...
See [Operators](https://github.com/Safe3/dsl/blob/master/docs/operators.md)
...
_See [Operators](https://github.com/Safe3/dsl/blob/master/docs/operators.md)
for more details._
...
Like Go, VDSL supports line comments (`//...`) and block comments
(`/* ... */`).
